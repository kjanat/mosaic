...
Side/future domains: `mos-cache`, `mos-packages`, and `mos-bib` should stay close to `mos-core`
until real integration requires more. `mos-lsp` may consume current compiler phases, but should stay
a thin protocol boundary.
