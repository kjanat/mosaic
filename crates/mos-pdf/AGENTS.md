...
`mos-pdf` consumes `mos-layout::PageGraph` and emits PDF. It owns object planning, content streams,
fonts, encodings, embedded subsets, images, and PDF metadata currently supported.
