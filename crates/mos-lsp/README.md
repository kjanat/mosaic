...
alias (`MOS0033`) in `data.legacyCode`, and a catalog link in `codeDescription.href`. Quick-fix
titles include both identities. Clients matching numeric `code` values must migrate; see the
